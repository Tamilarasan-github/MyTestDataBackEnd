...
public class TestScriptsExecutionHistorySpecifications implements Specification<TestScriptsExecutionHistoryEntity>
{
	
	private static final long serialVersionUID = 1L;
	public List<SearchCriteria> testScriptsExecutionHistorySearchCriteriaList;
	
	public TestScriptsExecutionHistorySpecifications()
	{
		testScriptsExecutionHistorySearchCriteriaList=new ArrayList<SearchCriteria>();
	}
	
	public void addNewTestSuiteExecutionHistorySpecifications(SearchCriteria newSearchCriteria)
	{
		testScriptsExecutionHistorySearchCriteriaList.add(newSearchCriteria);
	}
	
	@Override
	public Predicate toPredicate(Root<TestScriptsExecutionHistoryEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder)
	{
		List<Predicate> predicatesList = new ArrayList<Predicate>();
		
		for (SearchCriteria searchCriteria : testScriptsExecutionHistorySearchCriteriaList)
		{
...
//						}
	...
	public List<Predicate> conditions(List<Predicate> predicatesList,SearchCriteria searchCriteria, String fieldValue, Root<TestScriptsExecutionHistoryEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder)
	{
		if(searchCriteria.getOperator().equals(SearchOperator.IN))
		{
	...
	public List<Predicate> conditionsNumber(List<Predicate> predicatesList,SearchCriteria searchCriteria, long fieldValue, Root<TestScriptsExecutionHistoryEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder)
	{
		if(searchCriteria.getOperator().equals(SearchOperator.IN))
		{
			predicatesList.add(criteriaBuilder.in(root.get(searchCriteria.getKey())).value(fieldValue));
