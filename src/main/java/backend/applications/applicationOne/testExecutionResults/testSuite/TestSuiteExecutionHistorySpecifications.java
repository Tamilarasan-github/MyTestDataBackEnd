...
public class TestSuiteExecutionHistorySpecifications implements Specification<TestSuiteExecutionHistoryEntity>
{
	
	private static final long serialVersionUID = 1L;
	public List<SearchCriteria> testSuiteExecutionHistorySearchCriteriaList;
	
	public TestSuiteExecutionHistorySpecifications()
	{
		testSuiteExecutionHistorySearchCriteriaList=new ArrayList<SearchCriteria>();
	}
	
	public void addNewTestSuiteExecutionHistorySpecifications(SearchCriteria newSearchCriteria)
	{
		testSuiteExecutionHistorySearchCriteriaList.add(newSearchCriteria);
	}
	
	@Override
	public Predicate toPredicate(Root<TestSuiteExecutionHistoryEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder)
	{
		List<Predicate> predicatesList = new ArrayList<Predicate>();
		
		for (SearchCriteria searchCriteria : testSuiteExecutionHistorySearchCriteriaList)
		{
