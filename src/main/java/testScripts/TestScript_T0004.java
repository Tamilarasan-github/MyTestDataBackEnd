...
public class TestScript_T0004 extends Helper
{
	private static Logger log = LogManager.getLogger(TestScript_T0004.class.getName());

	@BeforeClass
	public void setValues()
	{
		description = "Open Google and Search";
		testcaseName = "TestScript_T0004";
	}
	...
	public void openGoogle()
	{
		...
		enterTextAndClickEnter(searchBar, "Hello World TestScript_T0004", true);
		log.debug("Hello World is entered into search bar");
		getWebDriver().quit();
		System.out.println("TestScript_T0004 - Completed");
	}
